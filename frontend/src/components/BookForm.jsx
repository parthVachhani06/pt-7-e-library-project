...
import { TextField, Button, Checkbox, FormControlLabel, Container, Box, Typography } from '@mui/material';
...
const BookForm = ({ id, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (id) {
        // Update book if an id is provided (edit mode)
